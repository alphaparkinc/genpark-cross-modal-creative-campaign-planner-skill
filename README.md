# genpark-cross-modal-creative-campaign-planner-skill
...
> **GenPark AI Agent Skill** -- Cross-modal brand visual identity & multi-platform ad matrix planner (Omniwork style)
